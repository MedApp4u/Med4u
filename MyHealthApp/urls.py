...
urlpatterns = [
    ...
    url(r'my_medicines/', views.ViewMedicine, name='my_medicines'),
    url(r'my_doctors/', views.ViewDoctor, name='my_doctors'),
    url(r'my_appointments/', views.ViewAppointment, name='my_appointments'),
    url(r'my_documents/', views.ViewDocument, name='my_documents'),
    url(r'my_diseases/', views.ViewDisease, name='my_diseases'),
    url(r'my_measurements/', views.ViewMeasurement, name='my_measurements'),
    url(r'my_insurances/', views.ViewInsurance, name='my_insurance'),
