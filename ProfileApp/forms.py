...
class ProfileForm(forms.ModelForm):
	...
	gender = forms.ChoiceField(choices=SEX_CHOICES, max_length=1, help_text='Enter M for Male and F for Female', label='Sex',required=True, widget=forms.RadioSelect(attrs={'class' : 'vp-form-field', 'id': 'vp-form-field-gender'}))
